...
@EnableJpaRepositories("com.shaik.domain")
public class DBConfig {
    ...
    public LocalValidatorFactoryBean validator() {
        ...
        //validatorFactoryBean.setMessageInterpolator(localeAwareMessageInterpolator());
        //validatorFactoryBean.setValidationMessageSource(validationMessageSource());
        validatorFactoryBean.setValidationPropertyMap(validatorProperties());
        return validatorFactoryBean;
    }

    private Map<String,String> validatorProperties() {
        Map<String,String> validatorProperties = new HashMap<>();
        Boolean failFast = env.getProperty("hibernate.validator.fail_fast",Boolean.class,Boolean.TRUE);
