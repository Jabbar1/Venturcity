...
public class MeterTemplateTest extends AbstractTestExecutionListener {
    ...
    public void create() throws Exception {
        ...
        Meter meter = new Meter.Builder().connectionID("Con_ID").month(Month.AUGUST).profile("ABCD").reading(10.09).build();
        meter = meterMeterOperations.create(meter);
        assertThat("Meter Reading is not saved", meter.getId(), is(notNullValue()));
    }

    @Test(expected = ConstraintValidationException.class)
    public void testForConstraint() throws Exception {

        Fraction fraction = new Fraction.Builder().fraction(0.3).month(Month.AUGUST).profile("ABCD").build();
        fraction = fractionOperations.create(fraction);
        assertThat("Fraction is Not Saved", fraction.getId(), is(notNullValue()));
        Meter meter = new Meter.Builder().connectionID("Con_ID").month(null).profile("ABCD").reading(10.09).build();
        meter = meterMeterOperations.create(meter);
        assertThat("Meter Reading is not saved", meter.getId(), is(notNullValue()));
    }
    ...
    public void update() throws Exception {
        ...
        fraction = fractionOperations.create(fraction);
        assertThat("Fraction is Not Saved", fraction.getId(), is(notNullValue()));
        Meter.Builder meter = new Meter.Builder().connectionID("Con_ID").month(Month.AUGUST).profile("ABCDE").reading(10.09);
    ...
    public void findAll() throws Exception {
        ...
        fraction = fractionOperations.create(fraction);
        assertThat("Fraction is Not Saved", fraction.getId(), is(notNullValue()));
        Meter meter = new Meter.Builder().connectionID("Con_ID").month(Month.AUGUST).profile("ABCDEFG").reading(10.09).build();
        meter = meterMeterOperations.create(meter);
        assertThat("Meter Reading is not saved", meter.getId(), is(notNullValue()));
    ...
    public void find() throws Exception {
        ...
        fraction = fractionOperations.create(fraction);
        assertThat("Fraction is Not Saved", fraction.getId(), is(notNullValue()));
        Meter meter = new Meter.Builder().connectionID("Con_ID").month(Month.AUGUST).profile("ABCDEFGE").reading(10.09).build();
        meter = meterMeterOperations.create(meter);
        assertThat("Meter Reading is not saved", meter.getId(), is(notNullValue()));
