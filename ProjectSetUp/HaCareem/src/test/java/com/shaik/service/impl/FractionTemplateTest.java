...
public class FractionTemplateTest extends AbstractTestExecutionListener {
    ...
    public void createWithNull() throws Exception {
        ...
        Fraction fraction = new Fraction.Builder().fraction(null).month(null).profile("ABCD").build();
    ...
    public void update() throws Exception {
        Fraction.Builder fraction = new Fraction.Builder().fraction(0.03).month(Month.AUGUST).profile("ABCD");
